...
import { AllProductsResponse, DeleteProductRequest, MessageResponse, NewProductRequest, ProductsResponse, SearchProductRequest, SearchProductResponse, UpdateProductRequest, categoriesResponse } from "../../types/api-types";
